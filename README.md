# Boardsource Wireless Lily 58 SMT Firmware

This repository contains the official ZMK configuration for the **Wireless Lily 58 SMT**. This PCB is designed for a seamless, cable-free experience with full support for ZMK Studio.
* **Product Page:** [Wireless Lily 58 SMT PCB](https://boardsource.xyz/products/lily-58-wireless-smt-pcb-assembled-hot-swap-zmk-compatible)
* **Full Documentation & Build Guide:** [Wireless SMT Lily 58 Docs](https://boardsource.xyz/blogs/guides/wireless-smt-lily58-docs)
